...
const offers = [
  ...
  },
  {
    ...
    copy: "Our Business Hutch foundation can be shaped around the way your company actually works. Start with a focused customer and project system, then add the modules your team needs without paying for a pile of tools you never use.",
